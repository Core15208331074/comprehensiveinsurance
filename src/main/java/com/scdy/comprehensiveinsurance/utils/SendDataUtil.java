...
public class SendDataUtil {
     ...
     * 构建发送指令.
     *
     * @param slaveAddressHex 从机地址
     * @param functionCodeHex 功能码
     * @return
     */
    public static String getSendInstruction(String slaveAddressHex, String functionCodeHex) {
        String hexInstruction = (slaveAddressHex + functionCodeHex)
                .replace(" ", "");
        String withCrc16 = getWithCrc16(hexInstruction);
        return withCrc16;
    }
     ...
     * @param slaveAddressHex      从机地址
     * @param functionCodeHex      功能码
     * @param dataLengthHex        数据长度
     * @param dataStartAddressHex1 寄存器地址1
     * @param dataStartAddressHex2 寄存器地址2
     * @return
     */
    public static String getSendInstruction(String slaveAddressHex, String functionCodeHex,
                                            String dataLengthHex, String dataStartAddressHex1, String dataStartAddressHex2) {
        String hexInstruction = (slaveAddressHex + functionCodeHex + dataLengthHex + dataStartAddressHex1 + dataStartAddressHex2)
                .replace(" ", "");
        String withCrc16 = getWithCrc16(hexInstruction);
        return withCrc16;
    }
     ...
     * @param slaveAddressHex     从机地址
     * @param functionCodeHex     功能码
     * @param dataStartAddressHex 数据起始地址
     * @param dataLengthHex       数据长度
     * @return
     */
    public static String getSendInstruction(String slaveAddressHex, String functionCodeHex,
                                            String dataStartAddressHex, String dataLengthHex) {
        String hexInstruction = (slaveAddressHex + functionCodeHex + dataStartAddressHex + dataLengthHex)
                .replace(" ", "");
        String withCrc16 = getWithCrc16(hexInstruction);
        return withCrc16;
    }
     ...
     * @return
     */
    public static String getCrc16(String toSend) {
        toSend = toSend.replace(" ", "");
        String withCrc16 = getWithCrc16(toSend);
        return withCrc16.substring(withCrc16.length() - 4);
    }
     ...
     * @return
     */
    public static String byteArrayToStr(byte[] raw) {
        if (raw == null) {
            return null;
        }
    ...
    public static void main(String[] args) {
        ...
        String hexStr = "21 03 00 03 00 04".replace(" ", "");
        String withCrc16 = SendDataUtil.getWithCrc16(hexStr);
        System.out.println(withCrc16);
    }
